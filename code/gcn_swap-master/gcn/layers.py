...
class GraphConvolution(Layer):
    ...
    def __init__(self, input_dim, output_dim, placeholders, dropout=0.,
                 sparse_inputs=False, act=tf.nn.relu, bias=False, order_num=1,
...
class GraphConvolutionOur(Layer):
    """Graph convolution layer."""
    def __init__(self, input_dim, output_dim, placeholders, dropout=0.,
                 sparse_inputs=False, act=tf.nn.relu, bias=False,
                 featureless=False, order_num=0, **kwargs):
        super(GraphConvolutionOur, self).__init__(**kwargs)
...
class GraphConvolutionSingleKernel(Layer):
    ...
    def __init__(self, input_dim, output_dim, placeholders, dropout=0.,
                 sparse_inputs=False, act=tf.nn.relu, bias=False,
                 featureless=False, order_num=0, **kwargs):
        super(GraphConvolutionSingleKernel, self).__init__(**kwargs)
    ...
    def _call(self, inputs):
        ...
        output = tf.add_n([order_list[0], order_list[-1]])
