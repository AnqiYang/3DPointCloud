...
for i in range(100):
    ...
    for order_num in order_num_list:
        for dropout in dropout_list:
            with open('citeseer_train_simple_output_transpose_a.py', 'r') as f:
                f_s = f.read()
            f_s_l = f_s.split('\n')
            ...
            with open('citeseer_train_tmp_transpose.py', 'w') as f:
                f.write(new_file)
            os.system('python citeseer_train_tmp_transpose.py')
